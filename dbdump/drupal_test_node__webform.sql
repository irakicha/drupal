...
DROP TABLE IF EXISTS `node__webform`;
...
LOCK TABLES `node__webform` WRITE;
/*!40000 ALTER TABLE `node__webform` DISABLE KEYS */;
/*!40000 ALTER TABLE `node__webform` ENABLE KEYS */;
UNLOCK TABLES;
